...
<div class="khoi-chua">
  ...
  ?>
    ...
    case 'danh-sach-thiet-bi':
        ...
        break;
    case 'ke-hoach-thanh-ly':
        require_once 'pages_nhan-vien-thiet-bi/ke-hoach-thanh-ly.php';
        break;
    ...
    case 'quan-ly-kiem-ke':
        ...
        break;
    case 'chi-tiet-thanh-ly':
        require_once 'pages_nhan-vien-thiet-bi/chi-tiet-thanh-ly.php';
        break;
    case 'lap-ke-hoach-thanh-ly':
        require_once 'pages_nhan-vien-thiet-bi/lap-ke-hoach-thanh-ly.php';
        break;
    case 'ket-qua-thong-ke':
        require_once 'pages_nhan-vien-thiet-bi/ket-qua-thong-ke.php';
        break;
    case 'chi-tiet-phieu-muon':
        require_once 'pages_nhan-vien-thiet-bi/chi-tiet-phieu-muon.php';
        break;
    default:
        require_once 'pages_nhan-vien-thiet-bi/danh-sach-thiet-bi.php';
}
