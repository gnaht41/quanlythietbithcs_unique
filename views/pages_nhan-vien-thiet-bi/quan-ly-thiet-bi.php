    ...
    <form method="GET" class="bo-loc">
        ...
        <select name="tinhTrang">
            ...
            <?php foreach ($listTinhTrang as $tt): ?>
                <option value="<?php echo $tt; ?>" <?php echo ($filters['tinhTrang'] == $tt) ? 'selected' : ''; ?>>
                    <?php echo $tt; ?>
                </option>
            <?php endforeach; ?>
        </select>
        ...
        <select name="lop">
            ...
            <?php foreach ($listLop as $l): ?>
                <option value="<?php echo $l; ?>" <?php echo ($filters['lop'] == $l) ? 'selected' : ''; ?>>
                    Lớp <?php echo $l; ?>
                </option>
            <?php endforeach; ?>
        </select>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="?tab=quan-ly-thiet-bi&action=xoa-thiet-bi&maTB=<?php echo $device['maTB']; ?>"
                                    ...
                                    onclick="return confirm('Bạn có chắc muốn xóa thiết bị &quot;<?php echo htmlspecialchars($device['tenTB']); ?>&quot; không?');">
                                    Xóa
                                </a>
